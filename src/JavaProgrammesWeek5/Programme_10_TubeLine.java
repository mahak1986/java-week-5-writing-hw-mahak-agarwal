...
//System.out.println(tubeStationZone1.length); //for debug purpose
        ...
        londonUGLines[2][10] = "Gloucester Road";
        londonUGLines[2][11] = "Great Portland Street";
        londonUGLines[2][12] = "High Street Kensington";
        londonUGLines[2][13] = "King's Cross";
        londonUGLines[2][14] = "Liverpool Street";
        londonUGLines[2][15] = "Mansion House";
        londonUGLines[2][16] = "Monument";
        londonUGLines[2][17] = "Notting Hill Gate";
        londonUGLines[2][18] = "Sloane Square";
        londonUGLines[2][19] = "South Kensington";
        londonUGLines[2][20] = "St Pancras";
        londonUGLines[2][21] = "Temple";
        londonUGLines[2][22] = "Tower Hill";
        londonUGLines[2][23] = "Victoria";
        londonUGLines[2][24] = "Westminster";
        londonUGLines[2][25] = "Euston Square";
